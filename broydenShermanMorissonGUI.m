function varargout = broydenShermanMorissonGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @broydenShermanMorissonGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @broydenShermanMorissonGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function broydenShermanMorissonGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = broydenShermanMorissonGUI_OutputFcn(hObject, eventdata, handles) 
...
% BroydenSherman metodu uyguladým. Euclidean
xoklid=BroydenSherman(Foklid, x0, tol, kmax);
set(handles.xp,'string',xoklid(1));
set(handles.yp,'string',xoklid(2));
set(handles.zp,'string',xoklid(3));
% BroydenSherman metodu uyguladým. Cosinus Distance
xcos=BroydenSherman(Fcos, x0, tol, kmax);
